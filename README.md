...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/maziz00/)
[![Medium](https://img.shields.io/badge/Medium-12100E?style=for-the-badge&logo=medium&logoColor=white)](https://medium.com/@maziz00)
[![Upwork](https://img.shields.io/badge/Upwork-6FDA44?style=for-the-badge&logo=upwork&logoColor=white)](https://www.upwork.com/freelancers/maziz00)
[![Newsletter](https://img.shields.io/badge/Newsletter-FF6719?style=for-the-badge&logo=substack&logoColor=white)](https://devopsdispatch.beehiiv.com)
...
```mermaid
graph TB
    subgraph "Source & Config"
        A[Git Repository] --> B[GitLab CI/CD]
        A --> B2[GitHub Actions]
    end
    ...
    subgraph "Infrastructure as Code"
        ...
        B2 --> C
        C --> D[GCP / AWS]
        E[Ansible] --> F[RHEL / CentOS Hardening]
    end

    subgraph "Container Platform"
        D --> G[GKE / EKS / OpenShift]
        G --> H[Helm Charts]
        H --> I[ArgoCD GitOps]
    end
...
![GCP](https://img.shields.io/badge/GCP-Expert-4285F4?style=flat-square&logo=googlecloud&logoColor=white)
...
| [🤖 openclaw-gcp](https://github.com/maziz00/openclaw-gcp) | Production-grade OpenClaw AI assistant on GCP, Terraform + Ansible, SE-Linux, cost monitoring | Terraform, Ansible, GCP, Docker |
...
**[Book a consultation on Upwork →](https://www.upwork.com/freelancers/maziz00?s=1110580753140797440)**  

**[Book 20 min call on Calendly →](https://calendly.com/maziz00/devops)**
